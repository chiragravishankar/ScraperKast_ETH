...
export default function BotQuickEdit({ bot, onClose }: BotQuickEditProps) {
  ...
  return (
    <tr className="bg-brand-dark/[0.03] border-b border-edge-2">
      <td colSpan={8} className="px-4 py-3">
        <div className="flex flex-wrap items-end gap-4">

          {/* Status */}
          <div>
            <p className="text-xs font-semibold text-ink-2 uppercase tracking-wide mb-1.5">Status</p>
          ...
          {/* Access level */}
          <div>
            <p className="text-xs font-semibold text-ink-2 uppercase tracking-wide mb-1.5">Access Level</p>
            <div className="flex rounded-lg border border-edge overflow-hidden text-sm">
          ...
          {accessLevel === 'custom' && (
            <div>
              <p className="text-xs font-semibold text-ink-2 uppercase tracking-wide mb-1.5">Price / Page (USDC)</p>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-28 pl-6 pr-3 py-1.5 rounded-lg border border-edge text-sm font-mono focus:outline-none focus:ring-2 focus:ring-brand-dark/30 focus:border-brand-dark"
                />
              </div>
            </div>
          )}
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button
              onClick={onClose}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-ink-2 hover:bg-slate-100 transition-colors border border-edge"
            >
